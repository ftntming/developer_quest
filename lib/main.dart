...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        ...
        child: MaterialApp(
          title: 'Flutter Demo',
          theme: ThemeData(brightness: Brightness.dark, primarySwatch: Colors.orange, canvasColor: Colors.transparent),
          routes: {
            '/': (context) => WelcomeScreen(),
            '/gameloop': (context) => GameScreen(),
            '/about': (context) => AboutScreen(),
            CodeChomper.miniGameRouteName: (context) {
              String filename = ModalRoute.of(context).settings.arguments as String;
              return CodeChomper(filename);
            },
            SphinxScreen.miniGameRouteName: (context) => const SphinxScreen(),
            SphinxScreen.fullGameRouteName: (context) => const SphinxScreen(fullGame: true),
            ...
            MainAxisCenterQuestion.routeName: (context) => const MainAxisCenterQuestion(),
            MainAxisSpaceAroundQuestion.routeName: (context) => const MainAxisSpaceAroundQuestion(),
            MainAxisSpaceBetweenQuestion.routeName: (context) => const MainAxisSpaceBetweenQuestion(),
            MainAxisStartQuestion.routeName: (context) => const MainAxisStartQuestion(),
            MainAxisEndQuestion.routeName: (context) => const MainAxisEndQuestion(),
            MainAxisSpaceEvenlyQuestion.routeName: (context) => const MainAxisSpaceEvenlyQuestion(),
            RowMainAxisEndQuestion.routeName: (context) => const RowMainAxisEndQuestion(),
            RowMainAxisStartQuestion.routeName: (context) => const RowMainAxisStartQuestion(),
            RowMainAxisSpaceBetween.routeName: (context) => const RowMainAxisSpaceBetween(),
          },
        ));
  }
